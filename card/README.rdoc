...
{Card _Cards_} are the basic building blocks of Decko. {Card::Set _Sets_} are the basic pattern for organizing cards. <b>Both Deckers and Deck-coders create web systems by applying _rules_ to _sets_ of _cards_.</b>
