...
(function() {
  ...
  $(window).ready(function() {
    ...
    return $('body').on("submit", "form", function() {
      ...
      if (uploader[0]) {
        return uploader.prop("disabled", true);
      }
    });
  });
...
(function() {
  ...
  jQuery.fn.extend({
    ...
    setSlotContent: function(newContent, mode, $slotter) {
      var v;
...
(function() {
  $(window).ready(function() {
    ...
    $('body').on('click', '[data-bs-dismiss="overlay"]', function(event) {
  ...
  jQuery.fn.extend({
    ...
    showSuccessResponse: function(responseData, mode) {
      if (responseData.redirect) {
        ...
        switch (mode) {
          ...
          default:
            return this.updateSlot(responseData, mode);
        }
      }
    },
    ...
    updateSlot: function(newContent, mode) {
      mode || (mode = "replace");
      return this.setSlotContent(newContent, mode, $(this));
    },
    ...
    uploadWithBlueimp: function(data, opt) {
      ...
      widget = input.data('wblueimpFileupload');
...
(function() {
  ...
  $(window).ready(function() {
    $('body').on('show.bs.tab', 'a.load[data-bs-toggle="tab"][data-url]', function(e) {
      var tab_id, url;
  ...
  FilterItemsBox = (function() {
    ...
    FilterItemsBox.prototype.updateOnSelect = function() {
      ...
      if (!this.duplicatesOk()) {
        ...
        f = new decko.filter(this.box.find('._filter-widget'));
        f.update();
...
(function() {
  ...
  decko.editorInitFunctionMap['._filtered-list'] = function() {
...
(function() {
  decko.slotReady(function(slot) {
    ...
    return slot.find('._select2autocomplete').each(function(_i) {
      return decko.initSelect2Autocomplete($(this), "complete");
    });
  });

  $.extend(decko, {
    initSelect2Autocomplete: function(el, search_view, prepareItems, templateResult, templateSelection, options) {
      var defaultOptions;
      ...
      return el.select2(defaultOptions);
    },
    autocompleteTemplateResult: function(i) {
      if (i.loading) {
        return i.text;
      }
      return '<span class="navbox-item-value ml-1">' + i.text + '</span>';
    },
    autocompleteTemplateSelection: function(i) {
      return '<span class="navbox-item-value ml-1">' + i.text + '</span>';
    },
    autocompletePrepareItems: function(response) {
      var items;
      items = [];
...
(function() {
  ...
  $(window).ready(function() {
    var navbox;
    navbox = $('._navbox');
    decko.initSelect2Autocomplete(navbox, "navbox_complete", navboxize, formatNavboxItem, formatNavboxSelectedItem, {
