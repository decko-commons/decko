  ...
  FilterItemsBox = (function() {
    ...
    FilterItemsBox.prototype.addSelectedCard = function(cardId) {
      ...
      return $.ajax({
        ...
        async: false,
        success: function(html) {
          return slot.find("._filtered-list").append(html);
        },
    ...
    FilterItemsBox.prototype.addSelectedUrl = function(cardId) {
      var view, wrap;
      view = this.box.data("itemView");
      wrap = this.box.data("itemWrap");
      return decko.path("~" + cardId + "/" + view + "?slot[wrap]=" + wrap);
    };

    FilterItemsBox.prototype.duplicatesOk = function() {
      return this.box.data("duplicatesOk");
    };
