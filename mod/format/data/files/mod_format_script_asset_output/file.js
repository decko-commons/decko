...
(function() {
  ...
  jQuery.fn.extend({
    ...
    slotReloading: function() {},
    slotLoadingComplete: function() {},
...
(function() {
  $(window).ready(function() {
    $('body').on('ajax:send', '.slotter', function(event, data) {
    ...
    $('body').on('ajax:complete', '.slotter', function(event, data) {
      return $(this).slot().slotLoadingComplete();
    });
