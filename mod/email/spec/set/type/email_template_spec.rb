...
describe Card::Set::Type::EmailTemplate do
  describe "#mail" do
    ...
    it "renders text email if text message given", as_bot: true do
      expect(content_type("+*text_message" => "text")).to include "text/plain"
    end

    it "renders html email if html message given", as_bot: true do
      expect(content_type("+*html_message" => "text")).to include "text/html"
    end

    it "renders multipart email if text and html given", as_bot: true do
